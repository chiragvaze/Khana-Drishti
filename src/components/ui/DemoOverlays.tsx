...
export function DemoOverlays() {
  ...
  return (
    <div className="fixed inset-0 z-[100] bg-mine-black/95 backdrop-blur-md flex items-center justify-center animate-fade-in">
      <div className="max-w-xl w-full mx-4">
        
        {!isCompletion ? (
          // Intro Overlay
          <div className="bg-mine-black-light border border-border/50 rounded-lg shadow-2xl p-8 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-3 mb-6">
                <div className="w-12 h-12 bg-amber/10 rounded-lg flex items-center justify-center border border-amber/20">
                  <Play className="w-6 h-6 text-amber" />
                </div>
                <div>
                  <h2 className="text-2xl font-bold text-text-primary tracking-tight">KHANAN DRISHTI</h2>
                  <p className="text-amber text-sm font-medium tracking-wide uppercase">From Field Evidence to Governance</p>
                </div>
              </div>
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="bg-mine-black p-4 rounded border border-border/30 mt-6">
                  <div className="text-xs text-text-muted mb-2 font-mono">SCENARIO TARGET</div>
                  <div className="flex justify-between items-center">
                    <span className="text-text-primary font-medium">Mine WCL-04</span>
          ...
          <div className="bg-mine-black-light border border-border/50 rounded-lg shadow-2xl p-8 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-text-primary tracking-tight">KHANAN DRISHTI</h2>
                  <p className="text-green-500 text-sm font-medium tracking-wide uppercase">From Field Evidence to Governance</p>
                </div>
              </div>
              
              <div className="space-y-3 mb-8">
                <p className="text-text-primary mb-4 font-medium">Scenario complete. The system successfully tracked:</p>
...
export function DemoControlBar() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-[100] bg-mine-black border-t border-amber/20 shadow-[0_-10px_40px_rgba(0,0,0,0.5)] animate-fade-in">
      <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-text-primary font-bold tracking-widest text-sm uppercase">DEMO MODE</span>
          </div>
          <div className="h-4 w-px bg-border"></div>
          <span className="text-text-secondary font-mono text-sm">WCL-04</span>
          <div className="h-4 w-px bg-border"></div>
          <span className="text-text-muted text-sm">Step {currentStep} of 8</span>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            onClick={nextStep}
            className="flex items-center gap-1 bg-amber/10 hover:bg-amber/20 text-amber border border-amber/20 hover:border-amber/40 px-4 py-1.5 rounded text-sm font-medium transition-all"
          ...
          <button
            onClick={exitDemo}
            className="text-text-muted hover:text-text-primary text-sm font-medium transition-colors flex items-center gap-1"
